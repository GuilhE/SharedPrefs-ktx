...
class SharedPrefsKtxTest {
    ...
    fun getObjectWithEmptyKey() {
        ...
        assertEquals(2, prefs.get("", Types.newParameterizedType(Int::class.java), 2, moshi))
    }
    ...
    fun getObjectWithType() {
        ...
        prefs.put("key", list, Types.newParameterizedType(List::class.java, MyObjectType::class.java))

        assertEquals(list, prefs.get("key", Types.newParameterizedType(List::class.java, MyObjectType::class.java), ArrayList<MyObjectType>()))
    ...
    fun getObjectWithTypeException() {
        ...
        prefs.put("key", list, Types.newParameterizedType(List::class.java, Integer::class.java))
        prefs.get("key", MyObjectType::class.java, "123")
    }
    ...
    fun getObjectReturnDefault() {
        ...
        assertEquals(defaultVal, prefs.get("key2", Types.newParameterizedType(Int::class.java), defaultVal))
